...
terminal = "termite"
fm     = terminal .. " -e ranger /home"
snap   = "gnome-screenshot"
browser = "firefox"
...
-- Register widget
vicious.register(mytextclock, vicious.widgets.date, "[ %b %d, %I:%M %p ] ", 60)
...
'<span><span>$1 |</span></span>', 0.3, "Master")
...
close = wibox.widget.textbox(" [")

netdownicon = wibox.widget.imagebox(beautiful.widget_net)
netupicon = wibox.widget.imagebox(beautiful.widget_netup)

netdowninfo = wibox.widget.textbox()
vicious.register(netdowninfo, vicious.widgets.net, 
  '<span>${wlp4s0 down_kb}</span>',
  3)

netupinfo = wibox.widget.textbox()
vicious.register(netupinfo, vicious.widgets.net, 
  '<span>${wlp4s0 up_kb} |</span>',
  3)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "BackSpace",     function () awful.util.spawn(snap)     end),
